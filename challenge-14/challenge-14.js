...
console.log(justMod2Or3)
    ...
    // com o método MAP: (Dá pra fazer, mas com o FILTER é melhor, pois o MAP percorre todo o array e retorna undefined nos números que não correspondem.)
    // console.log( '\n (Using MAP) Just module of division by 2 or 3:' );
    // var justMod2Or3 = justNumbers.filter( function(item) {
...
}, '') // As '' é o valor inicial do reduce, para não ficar com o P duplicado no começo
...
// var obj = numberObjects[1] // o [1] referencia o índice 1 do array que é o number: 2

  ...
  */
  ...
  // Sem o objeto this
  console.log( 'O nome das pessoas (sem usar o objeto this) é:' )
  function getFullNameInAnotherWay(obj){
    return `${obj.name} ${obj.lastName}`
  }
  console.log(getFullNameInAnotherWay(person1))
  console.log(getFullNameInAnotherWay(person2))
